...
def bridgewater_scraper():
    ...
    url = f"https://boards-api.greenhouse.io/v1/boards/bridgewater89/departments?timestamp={unique_identifier}"
    ...
    for job in data["departments"]:
        if job["jobs"]:
            for i in job["jobs"]:
                ...
                item['company'] = "BridgeWater Associates"
