...
def playstation_scraper():
    ...
    url = f"https://boards-api.greenhouse.io/v1/boards/sonyinteractiveentertainmentglobal/departments?timestamp={unique_identifier}"
